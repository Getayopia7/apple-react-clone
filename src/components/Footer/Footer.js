import React, { Component } from 'react'
 import $ from 'jquery'
 import {FooterData} from '../Asset/Data/FooterData.js'
    ...
    return (
      ...
      <footer className="footer-wrapper">
		<div className="container"> 
			<div className="upper-text-container"><br /><br /><br /><br /><br /><br /><br /><br />
			...
			<div className="copyright-wrapper row">
				...
				<div className="footer-country  col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
					<div className="flag-wrapper">src="#"</div> <div className="footer-country-name">United States</div> 
				</div>
			</div>
		</div>
	</footer>
